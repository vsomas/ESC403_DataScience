...
futurVal <- forecast(fitARIMA,h=20,level=c(95))#h=20: 20 values in future
plot(futurVal)

plot(futurVal$mean)
lines(futurVal$lower)
lines(futurVal$upper)
par(new=T)
plot(y[(length(y)-StepPred):length(y)],col= "red",type = "l")
