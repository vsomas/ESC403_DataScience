...
#res <- LSTM_sinus_prediction(lag, StepPred,lstm1_units,TrainValid_dat,test1,test2, scaledY = scaledY, y=y )
```
...
```{r}
res <- LSTM_sinus_prediction(lag, StepPred,lstm1_units,TrainValid_dat,test1,test2 )
```
